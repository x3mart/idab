...
class Schedule(models.Model):
    ...
    checkpoint = models.OneToOneField('checkpoints.Checkpoint', on_delete=models.CASCADE, verbose_name='Контрольная точка', null=True, blank=True, related_name='schedule')
