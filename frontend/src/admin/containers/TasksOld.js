...
import GroupSelectMenu from "./components/GroupSelectMenu";
...
const StudyMaterials = ({
  ...
  const handleGroupSelectAction = (id) => {
    setSelectedGroup(id)
    load_tasks(id)
  }
    ...
    <Fragment>
      ...
      <div className='main-body__users'>
        <div className='cards'>
          ...
          {/*<GroupSelectMenu list={groups_list} action={handleGroupSelectAction}/>*/}
          ...
          {tasksData.loaded && (
            <div className='cards'>
              <table className='table table-striped table-hover'>
                <thead>
                <tr>
                  {user && !user.is_student && <th><SelectGroup/></th>}
                  <th>Название</th>
