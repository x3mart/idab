...
const Teachers = ({
  ...
  const [teachersIdsList, setTeachersIdsList] = useState([])
  ...
  useEffect(() => {
    setTeachersIdsList(teachers_ids_list)
  }, [teachers_ids_list])

  useEffect(() => {
    setChecked(teachers_actions_list.length > 0 && teachers_actions_list.length === teachers_ids_list.length)
  }, [teachers_actions_list, teachers_ids_list])
        ...
        <div className="cards">
          <div className="cards__header table-title">
            ...
            <div>
              ...
              ><i className="material-icons">&#xE147;</i> <span>Добавить преподавателя</span>
              </button>
              <button
          ...
          <div className="cards">
            ...
            <span className="custom-checkbox">
                  ...
                  id="selectAll"
                  checked={checked}
                  onClick={() => checked ? remove_id(teachersIdsList) : add_id(teachersIdsList)}
                />
